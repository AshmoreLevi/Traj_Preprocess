            ...
            if 'highway' in w.tags:
                ...
                if need_add:
                    for n in w.nodes:
                        try:
                            self.nodes.add(n.ref)
                        except o.InvalidLocationError as e:
                            # 处理无效位置的异常
                            print(f"WARNING: Node {n.id} has InvalidLocationError: {e}. Ignoring.")
        except o.InvalidLocationError as e:
            # 处理无效位置的异常
            print(f"WARNING: Way {w.id} has InvalidLocationError: {e}. Ignoring.")                
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_path', default='beijing-latest.osm.pbf', help='the input path of the original osm data')
    parser.add_argument('--output_path', default='clipped_beijing.osm.pbf', help='the output path of the clipped osm data')
